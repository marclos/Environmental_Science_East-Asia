\chapter{Fossil Fuels: Energy Resources in the Lithosphere}\label{ch:ores}
...
\begin{figure}[h]
	\centering
		\includegraphics[width=1.00\textwidth]{graphics/Burning_of_natural_gases_Pangkalan_Brandan_Sumatra.tif}
