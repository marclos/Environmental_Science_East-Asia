...
\subsection{The Carbon Intensity of Crude Oil Projection}

Not all crude is the same. Besides differences in the quality of crude oil, the energy costs to extract, process, and use crude oil varies dramatically across the globe. \citet{Masnadi2018global} found... the some countries, e.g. Algeria, Venezuela, Cameron, and Canada, produce oil with 15 g CO2 eq / MJ of energy, while Denmark, Saudi Arabia, Bahreain, and Thailand are below 5 g CO2 eg/MJ. ...

\begin{figure}[h]
	\centering
		\includegraphics{graphics/Masnadi_2018_CarbonIntensityCrudeOil.jpg}
	\caption{masnadi 2018}
	\label{fig:Masnadi_2018_CarbonIntensityCrudeOil}
\end{figure}
