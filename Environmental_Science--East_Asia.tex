...
\input{chapters/03_Ores_Fuels}
%\input{chapters/03_Fossil_Fuels}
\input{chapters/031_Non-GHG_Energies}
\input{chapters/039_Evaporation_Precipitation}
\input{chapters/05_Pedogenesis}
\input{chapters/06_Biomass}
\input{chapters/07_Peatlands}
\input{chapters/08_Benthos}
\input{chapters/09_Subsidence}
\input{chapters/10_Hazards}

\part{Lateral Transport}

\input{chapters/04_Climate_Records}
\input{chapters/19_Floods_and_Droughts}
\input{chapters/20_Agroecology_Water_Korea}
\input{chapters/23_Water_Quality}
\input{chapters/21_Air_Quality}

\part{Bread Crumbs and Human Scenarios}

\input{chapters/XX_Biomimicry}
\input{chapters/XX_Sustainable_Food_Systems}
\input{chapters/XX_Social_Justice_Energy_Climate}
