...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/002_EarthSun}
\input{chapters/003_Evaporation_Precipitation}
\input{chapters/004_BiomassV2}
\input{chapters/005_Pedogenesis}
\input{chapters/006_Peatlands}

\input{chapters/007_Benthos}
\input{chapters/008_Subsidence}

\input{chapters/010_Hazards}
\input{chapters/011_Mining}
\input{chapters/012_Fossil_Fuels}
\input{chapters/013_Non-GHG_Energies}

\part{Lateral Transport}

\input{chapters/XXX_Peopling_of_East_Asia}
\input{chapters/014_Climate_Records}
\input{chapters/015_Floods_and_Droughts}
\input{chapters/016_Agroecology_Water_Korea}
\input{chapters/017_Water_Quality}
\input{chapters/018_Air_Quality}
\input{chapters/019_Solar_Wind_Tidal}

\part{Bread Crumbs and Human Scenarios}

\input{chapters/020_Biomimicry}
\input{chapters/021_Social_Justice_Energy_Climate}
\input{chapters/022_Sustainable_Food_Systems}
\input{chapters/023_Sustainable_Consumption}
